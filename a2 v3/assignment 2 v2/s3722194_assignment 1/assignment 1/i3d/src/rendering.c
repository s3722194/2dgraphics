...
void render_ship() {
	...
	glVertex3f(ship.shape[0].x, ship.shape[0].y, Z_LAYER);
	glVertex3f(ship.shape[1].x, ship.shape[1].y, Z_LAYER);
	glVertex3f(ship.shape[2].x, ship.shape[2].y, Z_LAYER);
	glEnd();

	glBegin(GL_POLYGON);
	glColor3f(ship.fill_colour.r, ship.fill_colour.g, ship.fill_colour.b);
	glVertex3f(ship.shape[3].x, ship.shape[3].y, Z_LAYER);
	glVertex3f(ship.shape[4].x, ship.shape[4].y, Z_LAYER);
	glVertex3f(ship.shape[5].x, ship.shape[5].y, Z_LAYER);
	glEnd();
...
void render_wall() {
	...
	glColor3f(wall.fill_colour.r, wall.fill_colour.g, wall.fill_colour.b);
	//glLineWidth(20.0);
	glVertex3f(wall.shape[0].x, wall.shape[0].y, Z_LAYER);
	glVertex3f(wall.shape[1].x, wall.shape[1].y, Z_LAYER);
	glVertex3f(wall.shape[2].x, wall.shape[2].y, Z_LAYER);
	glVertex3f(wall.shape[3].x, wall.shape[3].y, Z_LAYER);
