...
void create_gun() {
	...
	ship.gun.shape[0].x = 0.1;
	ship.gun.shape[0].y = 0.05;
	ship.gun.shape[0].z = 0;

	ship.gun.shape[1].x = 0.05;
	ship.gun.shape[1].y = 0.05;
	ship.gun.shape[1].z = 0;

	ship.gun.shape[2].x = 0.05;
	ship.gun.shape[2].y = 0.1;
	ship.shape[2].z = 1;

	ship.gun.shape[3].x = 0.1;
	ship.gun.shape[3].y = 0.1;
	ship.gun.shape[3].z = 0;

	ship.gun.shape[4].x = 0.0666;
	ship.gun.shape[4].y = 0.1;
	ship.gun.shape[4].z = 1;

	ship.gun.shape[5].x = 0.08333;
	ship.gun.shape[5].y = 0.1;
	ship.gun.shape[5].z = 0;

	ship.gun.shape[6].x = 0.08333;
	ship.gun.shape[6].y = 0.11;
	ship.gun.shape[6].z = 0;

	ship.gun.shape[7].x = 0.0666;
	ship.gun.shape[7].y = 0.11;
	ship.gun.shape[7].z = 0;
...
void create_asteroid() {
	asteroids.lauch_radius = wall.size +50;
	asteroids.wave = 1;
